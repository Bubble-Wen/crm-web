  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader>
        <el-button type="primary" :icon="CirclePlus" @click="openDrawer('新增')">新增线索</el-button>
      </template>
      <!-- 表格操作 -->
      <template #operation="scope">
        <el-button type="primary" link :icon="EditPen" @click="openDrawer('编辑', scope.row)">编辑</el-button>
        <el-button type="info" link :icon="Notification" @click="openFollowDrawer('编辑', scope.row)" v-if="scope.row.status === LeadStatus.NOT_CONVERTED">跟进线索</el-button>
        <el-button type="success" link :icon="Switch" @click="toCustomer(scope.row.id)" v-if="scope.row.status === LeadStatus.NOT_CONVERTED">转为客户</el-button>
      </template>
    </ProTable>
